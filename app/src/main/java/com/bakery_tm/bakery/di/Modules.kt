...
val predefinedProducts = listOf(
    ...
    ProductEntity(
        ...
        fullDescription = "Состав: молотый кофе, вода.",
        allergens = "Аллергены: отсутствуют",
        price = "2.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "300 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: эспрессо, молоко, молочная пена.",
        allergens = "Аллергены: молочные продукты",
        price = "3.20 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: эспрессо, молоко.",
        allergens = "Аллергены: молочные продукты",
        price = "3.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: эспрессо, молоко, шоколадный сироп.",
        allergens = "Аллергены: молочные продукты",
        price = "3.80 BYN",
    ...
    ProductEntity(
        ...
        weight = "250 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: двойной эспрессо, молоко.",
        allergens = "Аллергены: молочные продукты",
        price = "3.60 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: эспрессо, сливки, ванильный сахар.",
        allergens = "Аллергены: молочные продукты",
        price = "3.90 BYN",
    ...
    ProductEntity(
        ...
        fullDescription = "Состав: эспрессо, молоко, лёд.",
        allergens = "Аллергены: молочные продукты",
        price = "3.70 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: эспрессо, молоко, карамельный сироп.",
        allergens = "Аллергены: молочные продукты",
        price = "4.00 BYN",
    ...
    ProductEntity(
        ...
        weight = "250 мл",
        description = "Горячий напиток",
        fullDescription = "Состав: кофе, сливки, сахар, ирландский ликёр.",
        allergens = "Аллергены: молочные продукты. Алкоголь",
        price = "4.50 BYN",
    ...
    ProductEntity(
        ...
        fullDescription = "Состав: чай, лимон, сахар, лёд.",
        allergens = "Аллергены: лимон.",
        price = "2.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "450 мл",
        description = "Холодный напиток",
        fullDescription = "Состав: вода, лимон, сахар, мята.",
        allergens = "Аллергены: лимон, мята.",
        price = "2.80 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Холодный напиток",
        fullDescription = "Состав: матча, молоко, лёд.",
        allergens = "Аллергены: молочные продукты.",
        price = "4.00 BYN",
    ...
    ProductEntity(
        ...
        fullDescription = "Состав: молоко, мороженое, ваниль.",
        allergens = "Аллергены: молочные продукты.",
        price = "3.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "350 мл",
        description = "Молочный напиток",
        fullDescription = "Состав: молоко, мороженое, шоколадный сироп.",
        allergens = "Аллергены: молочные продукты.",
        price = "3.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "140 г",
        description = "Десерт",
        fullDescription = "Состав: сливочный сыр, печенье, яйца, сахар.",
        allergens = "Аллергены: глютен, молочные продукты, яйца.",
        price = "4.20 BYN",
    ...
    ProductEntity(
        ...
        weight = "140 г",
        description = "Десерт",
        fullDescription = "Состав: маскарпоне, яйца, сахар, кофе, печенье савоярди.",
        allergens = "Аллергены: глютен, молочные продукты, яйца.",
        price = "4.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "90 г",
        description = "Выпечка",
        fullDescription = "Состав: мука, яйца, сахар, масло, черника.",
        allergens = "Аллергены: глютен, молочные продукты, яйца.",
        price = "2.20 BYN",
    ...
    ProductEntity(
        ...
        weight = "90 г",
        description = "Выпечка",
        fullDescription = "Состав: слоёное тесто, миндальная начинка.",
        allergens = "Аллергены: глютен, орехи, молочные продукты.",
        price = "2.80 BYN",
    ...
    ProductEntity(
        ...
        weight = "110 г",
        description = "Десерт",
        fullDescription = "Состав: шоколад, мука, сахар, масло, яйца.",
        allergens = "Аллергены: глютен, орехи, молочные продукты.",
        price = "3.00 BYN",
    ...
    ProductEntity(
        ...
        weight = "130 г",
        description = "Выпечка",
        fullDescription = "Состав: мука, яблоки, корица, сахар.",
        allergens = "Аллергены: глютен, яблоки.",
        price = "3.20 BYN",
    ...
    ProductEntity(
        ...
        weight = "180 г",
        description = "Сэндвич",
        fullDescription = "Состав: хлеб, ветчина, сыр, салат.",
        allergens = "Аллергены: глютен, молочные продукты.",
        price = "3.80 BYN",
    ...
    ProductEntity(
        ...
        weight = "200 г",
        description = "Бейгл",
        fullDescription = "Состав: бейгл, лосось, сливочный сыр, салат.",
        allergens = "Аллергены: глютен, рыба, молочные продукты.",
        price = "4.50 BYN",
    ...
    ProductEntity(
        ...
        weight = "160 г",
        description = "Завтрак",
        fullDescription = "Состав: хлеб, авокадо, специи.",
        allergens = "Аллергены: глютен.",
        price = "3.90 BYN",
    ...
    ProductEntity(
        ...
        weight = "250 г",
        description = "Завтрак",
        fullDescription = "Состав: овсянка, молоко, ягоды.",
        allergens = "Аллергены: глютен, молочные продукты.",
        price = "3.00 BYN",
    ...
    ProductEntity(
        ...
        weight = "200 г",
        description = "Завтрак",
        fullDescription = "Состав: йогурт, гранола, ягоды.",
        allergens = "Аллергены:  молочные продукты, орехи (в граноле).",
        price = "2.80 BYN",
